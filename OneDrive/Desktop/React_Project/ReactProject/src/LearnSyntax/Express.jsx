...
const Express = () => {
  ...
  const getDisplayContent = () => {
    ...
    if (selectedContent && selectedTopic && selectedSub && selectedMain) {
      const content =
      ExpressJS[selectedMain][selectedSub][selectedTopic][selectedContent];
      return {
    ...
    if (selectedTopic && selectedSub && selectedMain) {
      const topic = ExpressJS[selectedMain][selectedSub][selectedTopic];
    ...
    if (selectedSub && selectedMain) {
      const sub = ExpressJS[selectedMain][selectedSub];
    ...
    if (selectedMain) {
      const main = ExpressJS[selectedMain];
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-xl font-bold mb-4">Express Tutorial</h1>
        {Object.entries(ExpressJS).map(([main, mainContent]) => (
        ...
        {displayContent ? (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
              ...
              <span style={{ color: "#C586C0", fontSize: "14px" }}>ExpressJS</span>
            </div>
