...
const JAVA = () => {
  ...
  const getDisplayContent = () => {
    ...
    if (selectedContent && selectedTopic && selectedSub && selectedMain) {
      const content =
      JAVA[selectedMain][selectedSub][selectedTopic][selectedContent];
      return {
    ...
    if (selectedTopic && selectedSub && selectedMain) {
      const topic = JAVA[selectedMain][selectedSub][selectedTopic];
    ...
    if (selectedSub && selectedMain) {
      const sub = JAVA[selectedMain][selectedSub];
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-xl font-bold mb-4">JAVA Tutorial</h1>
        {Object.entries(JAVA).map(([main, mainContent]) => (
        ...
        {displayContent ? (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
              ...
              <span style={{ color: "#C586C0", fontSize: "14px" }}>JAVA</span>
            </div>
