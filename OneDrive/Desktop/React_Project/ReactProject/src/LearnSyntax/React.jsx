...
const Reactt = () => {
  ...
  const getDisplayContent = () => {
    ...
    if (selectedContent && selectedTopic && selectedSub && selectedMain) {
      const content =
      ReactJS[selectedMain][selectedSub][selectedTopic][selectedContent];
      return {
    ...
    if (selectedTopic && selectedSub && selectedMain) {
      const topic = ReactJS[selectedMain][selectedSub][selectedTopic];
    ...
    if (selectedSub && selectedMain) {
      const sub = ReactJS[selectedMain][selectedSub];
    ...
    if (selectedMain) {
      const main = ReactJS[selectedMain];
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-xl font-bold mb-4">React Tutorial</h1>
        {Object.entries(ReactJS).map(([main, mainContent]) => (
        ...
        {displayContent ? (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
              ...
              <span style={{ color: "#C586C0", fontSize: "14px" }}>ReactJS</span>
            </div>
