...
const CSS = () => {
  ...
  const getDisplayContent = () => {
    ...
    if (selectedContent && selectedTopic && selectedSub && selectedMain) {
      const content =
      CSS[selectedMain][selectedSub][selectedTopic][selectedContent];
      return {
    ...
    if (selectedTopic && selectedSub && selectedMain) {
      const topic = CSS[selectedMain][selectedSub][selectedTopic];
    ...
    if (selectedSub && selectedMain) {
      const sub = CSS[selectedMain][selectedSub];
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-xl font-bold mb-4">CSS Tutorial</h1>
        {Object.entries(CSS).map(([main, mainContent]) => (
        ...
        {displayContent ? (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
              ...
              <span style={{ color: "#C586C0", fontSize: "14px" }}>CSS</span>
            </div>
