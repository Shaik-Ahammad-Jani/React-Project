...
const Python = () => {
  ...
  const getDisplayContent = () => {
    ...
    if (selectedContent && selectedTopic && selectedSub && selectedMain) {
      const content =
      Python[selectedMain][selectedSub][selectedTopic][selectedContent];
      return {
    ...
    if (selectedTopic && selectedSub && selectedMain) {
      const topic = Python[selectedMain][selectedSub][selectedTopic];
    ...
    if (selectedSub && selectedMain) {
      const sub = Python[selectedMain][selectedSub];
    ...
    if (selectedMain) {
      const main = Python[selectedMain];
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-xl font-bold mb-4">Python Tutorial</h1>
        {Object.entries(Python).map(([main, mainContent]) => (
        ...
        {displayContent ? (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
              ...
              <span style={{ color: "#C586C0", fontSize: "14px" }}>Python</span>
            </div>
